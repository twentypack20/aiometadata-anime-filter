...
export interface AppConfig {
  ...
  /** Hide titles detected as anime from non-anime discovery catalogs. */
  excludeAnimeFromGeneralCatalogs: boolean;
  hideWatchedTrakt?: boolean;
  hideWatchedAnilist?: boolean;
  hideWatchedMdblist?: boolean;
  hideWatchedSimkl?: boolean;
  ...
  search: {
    ...
    providers: {
        ...
        anime_movie: 'mal.search.movie' | 'kitsu.search.movie' | 'simkl.search.movie' | 'local.anime.search.movie';
        anime_series: 'mal.search.series' | 'kitsu.search.series' | 'simkl.search.series' | 'local.anime.search.series';
